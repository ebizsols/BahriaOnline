			...
			<div class="tg-topcategories tg-topcategoriesvtwo">					
				<?php 
					...
					foreach ( $terms as $key => $value ) {
						...
						$cat_image = !empty( $term_data['country_image']['url'] ) ? $term_data['country_image']['url'] : esc_url( get_template_directory_uri()).'/images/locations/country.jpg';
						$total_users	= listingo_get_total_users_under_taxanomy($country_name,'number','country');
					?>										
					<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
						<div class="tg-category">
							<figure>									
								<img src="<?php echo esc_url( $cat_image ); ?>" alt="<?php esc_attr_e('Country Image', 'listingo'); ?>">									
								<figcaption class="tg-automotive">
									<div class="tg-catagorycontent">
										<h3><a href="<?php echo esc_url( get_term_link( $value->term_id, 'countries' ) ); ?>"><?php echo esc_html( $value->name ); ?></a></h3>
