	...
	<div class="col-xs-12 col-sm-12 col-md-12">
		...
		<div class="sp-searchQBox">
		  <form class="sp-qform-search">
			  <input type="text" name="search_string" id="ask_search_question" value="" class="form-control field-control suggestquestion autocomplete-input" placeholder="<?php esc_attr_e('E.g. I am a 25yr old male &amp; have backache for last 2 months', 'listingo');?>">
			  <input class="submitquestion" data-toggle="modal" id="ask_btn" type="button" data-target=".AskQ" value="<?php esc_attr_e('SUBMIT QUESTION', 'listingo');?>">
		  </form>
		</div>
		<?php 
					...
					<form class="tg-themeform fw_ext_questions_form">
						<fieldset>
							<div class="form-group">
								<input type="text" class="question_title" name="question_title" placeholder="<?php esc_attr_e('Question title', 'listingo'); ?>">
							</div>
							<div class="form-group">
							...
							<textarea class="question_details" name="question_description" placeholder="<?php esc_attr_e('Ask question here', 'listingo'); ?>"></textarea>
