					...
					<figcaption>
					  <div class="tg-featuredprofilecontent">
						<div class="tg-contentbox">
						  <div class="tg-companylogo"><a href="<?php echo esc_url(get_author_posts_url($user->ID)); ?>"><img src="<?php echo esc_url($avatar); ?>" alt="<?php esc_attr_e('Profile Avatar', 'listingo'); ?>"></a></div>
