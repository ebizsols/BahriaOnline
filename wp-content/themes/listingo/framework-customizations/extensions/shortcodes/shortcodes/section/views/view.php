	...
	<section id="tg-twocolumns-upper" class="tg-twocolumns section-with-sidebar tg-haslayout">
        <div class="col-xs-12 col-sm-12 col-md-9 <?php echo sanitize_html_class( $section_position );?>">
          <div id="tg-content-upper" class="tg-content tg-haslayout">
              <section  class="tg-main-section haslayout <?php echo implode(' ',$section_extra_classes ) ?>" <?php echo do_shortcode($custom_id); ?> <?php echo do_shortcode($section_style); ?> <?php echo do_shortcode($bg_video_data_attr); ?> <?php echo do_shortcode($paralaxx_configuration); ?>>
                <div class="builder-items">
                    <?php if (isset($atts['section_heading']) && !empty($atts['section_heading'])) { ?>
                        <h2 class="tg-section-title"><?php echo esc_html($atts['section_heading']); ?></h2>
                    <?php } ?>
...
<?php } else{?>
    <section  class="tg-main-section tg-haslayout <?php echo implode(' ',$section_extra_classes ) ?>" <?php echo do_shortcode($custom_id); ?> <?php echo do_shortcode($section_style); ?> <?php echo do_shortcode($bg_video_data_attr); ?> <?php echo do_shortcode($paralaxx_configuration); ?>>
        <div class="builder-items">
            <?php if (isset($atts['section_heading']) && !empty($atts['section_heading'])) { ?>
                <h2 class="tg-section-title"><?php echo esc_html($atts['section_heading']); ?></h2>
            <?php } ?>
    ...
    <?php echo do_shortcode($full_width_section );?>
<?php }?>
