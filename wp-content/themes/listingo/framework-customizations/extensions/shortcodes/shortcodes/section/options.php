            ...
            'sidebar' => array(
                ...
                'picker' => array(
                    'gadget' => array(
                        ...
                        'type' => 'image-picker',
                        'choices' => array(
                            'full' => esc_url( get_template_directory_uri()) . '/images/sidebars/full.png',
                            'left' => esc_url( get_template_directory_uri() ). '/images/sidebars/left.png',
                            'right' => esc_url( get_template_directory_uri() ). '/images/sidebars/right.png',
                        )
                    )
                ),
                'choices' => array(
