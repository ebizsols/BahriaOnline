            ...
            <div class="tg-sectionhead">
                <?php if (!empty($atts['news_heading'])) { ?>
                    <div class="tg-sectiontitle">
                        <h2><?php echo esc_html($atts['news_heading']); ?></h2>
                    </div>
                <?php } ?>
							...
							<div class="tg-serviceprovidercontent">
								<div class="tg-companylogo">
									<a href="<?php echo esc_url(get_author_posts_url($author_id)); ?>">
										<img src="<?php echo esc_url($author_avatar); ?>" alt="<?php esc_attr_e('author', 'listingo'); ?>">
									</a>
								</div>
								<div class="tg-companycontent">
									<div class="tg-title">
										<h2 class="sp-written-by"><?php esc_html_e('Written by', 'listingo'); ?>&nbsp;<a href="<?php echo esc_url(get_author_posts_url($author_id)); ?>"><?php echo esc_html($author_name); ?></a></h2>
									</div>
