                        ...
                        'options' => array(
                            'general-group' => array(
                                ...
                                'options' => array(
									...
									'post_job_emails' => array(
                                        'label' => esc_html__('Send emails to providers', 'listingo'),
                                        'type' => 'select',
                                        'desc' => esc_html__('Send emails to related providers, once a new job is posted', 'listingo'),
										'value' => 'no',
                                        'choices' => array(
                                            'yes' 	=> esc_html__('Yes', 'listingo'),
                                            'no' 	=> esc_html__('No', 'listingo'),
