...
$extension->set_thumbnail( esc_url( get_template_directory_uri()).'/images/articles.png' );
...
$extension->set_thumbnail( esc_url( get_template_directory_uri()).'/images/questions.jpg' );
