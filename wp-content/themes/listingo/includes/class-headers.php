...
if (!class_exists('Listingo_Prepare_Headers')) {
    ...
    class Listingo_Prepare_Headers {
        ...
        public function listingo_app_available() {
            ...
            if ( apply_filters('listingo_get_domain',false) === true ) {?>
                <a target="_blank" class="tg-appavailable" href="https://codecanyon.net/item/listingo-service-providers-business-finder-android-native-app/21435746">
                    <img class="bubbleicon" src="<?php echo esc_url( get_template_directory_uri()); ?>/images/bubble.png" alt="<?php esc_attr_e('APP','listingo');?>">
                    <img class="android-logo" src="<?php echo esc_url( get_template_directory_uri()); ?>/images/android-logo.png" alt="<?php esc_attr_e('APP','listingo');?>">
                </a>
                <?php
                echo ob_get_clean();
            }
                    ...
                    if (isset($preloader['enable']['preloader']['gadget']) && $preloader['enable']['preloader']['gadget'] === 'default') {
                        ...
                        <div class="preloader-outer">
                            <div class="preloader-inner">
                                <img width="100" src="<?php echo esc_url($preloader['enable']['preloader']['custom']['loader']['url']); ?>" alt="<?php esc_attr_e('loader', 'listingo'); ?>" />
                            </div>
                        </div>
                        <?php
                    }
        ...
        public function listingo_do_process_header_v2() {
            ...
            if ( apply_filters('listingo_get_domain',false) === true && $post_name === "home-3") {
                                            ...
                                            <?php if (!empty($contact_address)) { ?>
                                                <li>
                                                    ...
                                                    <div class="tg-contentbox">
                                                        <address><?php echo do_shortcode($contact_address); ?></address>
                                                    </div>
                                                </li>
                                            <?php } ?>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="tg-contentbox">
                                                        <?php if (!empty($contact_phone)) { ?>
                                                            <span><a href="tel:<?php echo esc_attr($contact_phone); ?>"><?php echo esc_html($contact_phone); ?></a></span>
                                                        <?php } ?>
        ...
        public function listingo_do_process_header_v5() {
            ...
            if (!empty($main_logo['url'])) {
                ...
                $logo = esc_url( get_template_directory_uri() ) . '/images/logo-new.png';
            }
        ...
        public function listingo_prepare_top_strip() {
            ...
            ?>
            <div class="tg-topbar tg-haslayout" <?php echo do_shortcode($bg_color ); ?>>
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12 col-xs-12">
                                        ...
                                        if (!empty($contact_label)) {
                                            ...
                                            <li>
                                                ...
                                                <?php if (!empty($contact_label)) { ?>
                                                    <a href="<?php echo esc_attr($data_link); ?>"><?php echo esc_html($contact_label); ?></a>
                                                <?php } ?>
                                            </li>
                                        <?php } ?>
                                    <?php } ?>
        ...
        public function listingo_prepare_logo($logo = '') {
            ...
            if ( apply_filters('listingo_get_domain',false) === true ) {
                if (isset($post_name) && $post_name === 'home-page-8') {
                    $logo = esc_url( get_template_directory_uri() ) . '/images/logo_blue_header.png';
                } else if (isset($post_name) && $post_name === 'home-page-7') {
                    $logo = esc_url( get_template_directory_uri() ) . '/images/logo_green_header.png';
                }
            }
         ...
         * @return {}
         */
        public static function listingo_prepare_navigation($location = 'primary-menu', $id = 'menus', $class = '', $depth = '0') {
