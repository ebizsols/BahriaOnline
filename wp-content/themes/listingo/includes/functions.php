    ...
    function listingo_prepare_pagination($pages = '', $range = 4) {
        ...
        if (is_tax('sub_category') || is_tax('countries') || is_tax('cities') || is_tax('languages') || is_tax('amenities') || is_tax('insurance')
            ...
            if (1 != $pages) {
                ...
                for ($i = 1; $i <= $pages; $i++) {
                    if (1 != $pages && (!( $i >= $current_page + $range + 1 || $i <= $current_page - $range - 1 ) )) {
                        echo do_shortcode($paged == $i ) ? "<li class=\"tg-active\"><a href='javascript:;'>" . $i . "</a></li>" : "<li><a href='?current_page=" . ($i) . "' class=\"inactive\">" . $i . "</a></li>";
                    }
                }
            ...
            if (1 != $pages) {
                ...
                for ($i = 1; $i <= $pages; $i++) {
                    if (1 != $pages && (!( $i >= $current_page + $range + 1 || $i <= $current_page - $range - 1 ) )) {
                        echo do_shortcode($paged == $i ) ? "<li class=\"tg-active\"><a href='javascript:;'>" . $i . "</a></li>" : "<li><a href='" . get_pagenum_link($i) . "' class=\"inactive\">" . $i . "</a></li>";
                    }
                }
        ...
        if (!empty($terms)) {
            ...
            <div class="tg-posttags">
                ...
                <?php foreach ($terms as $key => $terms) { ?>
                    <a class="tg-tag <?php echo esc_attr($classes); ?>" href="<?php echo get_term_link($terms->term_id, $categoty_type); ?>"><?php echo esc_html($terms->name); ?></a>
                <?php } ?>
