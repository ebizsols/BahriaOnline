...
This is confirmation that your booking regarding "%service%" with %provider% has been received.
               ...
               <div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pull-left">
						...
						<div class="form-group">
							<input type="text" value="<?php echo esc_attr($appointment_title); ?>" name="appointment_inst_title" class="form-control" placeholder="<?php esc_attr_e('Instructions Heading', 'listingo'); ?>">
						</div>
					</div>
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pull-left">
						<div class="tg-dashboardhead">
               ...
               <div class="row">
												...
												<div class="tg-startendtime">
													<div class="form-group">
														<div class="tg-inpuicon">
															...
															<input type="text" value="<?php echo esc_attr($types); ?>" name="appointment_types[<?php echo esc_attr($key); ?>]" class="form-control" placeholder="<?php esc_attr_e('Add Appointment Type', 'listingo'); ?>">
														</div>
													</div>
										...
										foreach ($appointment_reasons as $key => $reason) {
											...
											<div class="tg-startendtime">
												<div class="form-group">
													<div class="tg-inpuicon">
														<i class="lnr lnr-calendar-full"></i>
														<input type="text" value="<?php echo esc_attr($reason); ?>" name="appointment_reasons[<?php echo esc_attr($key); ?>]" class="form-control" placeholder="<?php esc_attr_e('Add Appointment Reason', 'listingo'); ?>">
													</div>
												</div>
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pull-left">
						<div class="tg-dashboardbox appointment-confirm appointment-email-wrap">
							<div class="tg-dashboardtitle">
								<h2><?php esc_html_e('Email Settings - Booking Confirmation', 'listingo'); ?></h2>
							</div>
						...
						<div class="tg-dashboardbox appointment-cancelled appointment-email-wrap">
							<div class="tg-dashboardtitle">
								<h2><?php esc_html_e('Email Settings - Appointment Cancelled', 'listingo'); ?></h2>
							</div>
							<em class="email-hint"><strong>%customer_name%</strong>&nbsp;-- <?php esc_html_e('To display customer name', 'listingo'); ?></em>
							<em class="email-hint"><strong>%service%</strong>&nbsp;-- <?php esc_html_e('To display appointment service', 'listingo'); ?></em>
							<em class="email-hint"><strong>%provider%</strong>&nbsp;-- <?php esc_html_e('To display provider name', 'listingo'); ?></em>
						...
						<div class="tg-dashboardbox appointment-approved  appointment-email-wrap">
							<div class="tg-dashboardtitle">
								<h2><?php esc_html_e('Email Settings - Appointment Approved', 'listingo'); ?></h2>
							</div>
							<em class="email-hint"><strong>%customer_name%</strong>&nbsp;-- <?php esc_html_e('To display customer name', 'listingo'); ?></em>
							<em class="email-hint"><strong>%service%</strong>&nbsp;-- <?php esc_html_e('To display appointment service', 'listingo'); ?></em>
							<em class="email-hint"><strong>%provider%</strong>&nbsp;-- <?php esc_html_e('To display provider name', 'listingo'); ?></em>
...
<script type="text/template" id="tmpl-load-appointment-types">
    ...
    <div class="tg-inpuicon">
    <i class="lnr lnr-calendar-full"></i>
    <input type="text" name="appointment_types[]" class="form-control" placeholder="<?php esc_attr_e('Add Appointment Type', 'listingo'); ?>">
    </div>
    </div>
    <button type="button" class="tg-addtimeslot tg-deleteslot delete-appointment-type-slot"><i class="lnr lnr-trash"></i></button>
    </div>
...
<script type="text/template" id="tmpl-load-appointment-reasons">
    ...
    <div class="tg-inpuicon">
    <i class="lnr lnr-calendar-full"></i>
    <input type="text" name="appointment_reasons[]" class="form-control" placeholder="<?php esc_attr_e('Add Appointment Reason', 'listingo'); ?>">
    </div>
    </div>
    <button type="button" class="tg-addtimeslot tg-deleteslot delete-appointment-reason-slot"><i class="lnr lnr-trash"></i></button>
    </div>
