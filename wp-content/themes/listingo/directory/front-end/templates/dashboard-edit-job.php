                        ...
                        <form class="tg-themeform tg-formamanagejobs sp-dashboard-profile-form">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left">
                                        <div class="form-group">
                                            <input type="text" value="<?php the_title(); ?>" name="job[title]" class="form-control" placeholder="<?php esc_attr_e('Job Title', 'listingo'); ?>">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left">
                                        <div class="form-group tg-iconinput">
                                            ...
                                            <input type="text" value="<?php echo esc_attr($expirydate); ?>" name="job[expirydate]" class="form-control expirydate" placeholder="<?php esc_attr_e('Expire Date', 'listingo'); ?>">
                                        </div>
                                    </div>
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left tg-columnpadding">
                                        <div class="form-group tg-inputborder">
                                            <input type="text" value="<?php echo esc_attr($salary); ?>" name="job[salary]" class="form-control" placeholder="<?php esc_attr_e('Add salary/cost', 'listingo'); ?>">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left tg-columnpadding">
                                        <div class="form-group tg-inputborder">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left tg-columnpadding">
                                        <div class="form-group tg-inputborder">
                                            <input type="text" value="<?php echo esc_attr($qualification); ?>" name="job[qualification]" class="form-control" placeholder="<?php esc_attr_e('What minimum qualification is required?', 'listingo'); ?>">
                                        </div>
                                    </div>
                                                            ...
                                                            if (!empty($language->term_id)) {
                                                                ...
                                                                <li data-language-key="punjabi">
                                                                    <span class="tg-tagdashboard">
                                                                        ...
                                                                        <em><?php echo esc_html($language->name); ?></em>
                                                                    </span>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pull-right">
                                        <div class="tg-addallowances">
                                            <div class="tg-addallowance">
                                                <div class="form-group">
                                                    <input type="text" name="allowances" class="form-control input-feature" placeholder="<?php esc_attr_e('Benefits / Allowances', 'listingo'); ?>">
                                ...
                                <div class="tg-dashboardbox tg-location">
                                    ...
                                    <div class="tg-locationbox">
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left">
                                                <div class="form-group">
                                                    <input type="text" name="location[phone]" value="<?php echo esc_attr($phone); ?>" class="form-control" placeholder="<?php esc_attr_e('Phone', 'listingo'); ?>">
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left">
                                                <div class="form-group">
                                                    <input type="text" name="location[fax]" value="<?php echo esc_attr($fax); ?>" class="form-control" placeholder="<?php esc_attr_e('Fax', 'listingo'); ?>">
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left">
                                                <div class="form-group">
                                                    <input type="email" name="location[email]" value="<?php echo esc_attr($email); ?>" class="form-control" placeholder="<?php esc_attr_e('Email', 'listingo'); ?>">
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left">
                                                <div class="form-group">
                                                    <input type="text" name="location[url]" value="<?php echo esc_attr($user_url); ?>" class="form-control" placeholder="<?php esc_attr_e('URL', 'listingo'); ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 pull-left">
                                                <div class="form-group">
                                                    <input type="text" value="<?php echo esc_attr($longitude); ?>" placeholder="<?php esc_attr_e('Longitude', 'listingo'); ?>" name="location[longitude]" class="form-control" id="location-longitude" />
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 pull-left">
                                                <div class="form-group">
                                                    <input type="text" placeholder="<?php esc_attr_e('Latitude', 'listingo'); ?>" value="<?php echo esc_attr($latitude); ?>" name="location[latitude]" class="form-control" id="location-latitude" />
                                                </div>
                                            </div>
