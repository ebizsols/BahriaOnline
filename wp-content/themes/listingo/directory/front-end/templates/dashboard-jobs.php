                    ...
                    <div class="tg-sortfilter tg-sortby">
                        <div class="tg-select">
                            <select name="sort" class="sort_by">
                                <option value="ID" <?php echo isset($_GET['sort']) && $_GET['sort'] == 'ID' ? 'selected' : ''; ?>><?php esc_html_e('Latest jobs at top', 'listingo'); ?></option>
                ...
                <tbody>
                    ...
                    while ($query->have_posts()) : $query->the_post();
                        ...
                        <tr>
                            <td>
                                ...
                                <div class="tg-contentbox"> 
                                    <?php if (!empty($job_type[$type])) { ?>
                                        <a class="tg-tag tg-featuredtag" href="javascript:;"><?php echo esc_html($job_type[$type]); ?></a>
                                    <?php } ?>
                                    <div class="tg-title">
                            ...
                            <td><span><?php echo esc_html($expiry); ?></span></td>
                            <td><?php if (!empty($salary)) { ?><span><?php echo esc_html($salary); ?></span><?php } ?></td>
                        </tr>
                        <?php
                    endwhile;
                    wp_reset_postdata();
