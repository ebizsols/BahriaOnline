                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 pull-left">
                        <div class="form-group">
                            <input type="password" name="old_passowrd" class="form-control" placeholder="<?php esc_attr_e('Current Password', 'listingo'); ?>">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 pull-left">
                        <div class="form-group">
                            <input type="password" name="new_passowrd" class="form-control" placeholder="<?php esc_attr_e('New Password', 'listingo'); ?>">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 pull-left">
                        <div class="form-group">
                            <input type="password" name="confirm_password" class="form-control" placeholder="<?php esc_attr_e('Retype Password', 'listingo'); ?>">
                        </div>
                    </div>
            ...
            <fieldset>
                ...
                <?php if (!empty($delete_account_text)) { ?>
                    <div class="tg-description">
                        <p><?php echo esc_html($delete_account_text); ?></p>
                    </div>
                <?php } ?>
                <div class="row">
                    <?php if (isset($activation_status) && $activation_status == 'active') { ?>
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 pull-left">
                            <div class="form-group">
                                <input type="password" name="currentpassword" class="form-control" placeholder="<?php esc_attr_e('Current Password', 'listingo'); ?>">
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 pull-left">
                            <div class="form-group">
                                <input type="password" name="retypepassword" class="form-control" placeholder="<?php esc_attr_e('Retype Password', 'listingo'); ?>">
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pull-left">
                            <div class="form-group">
                                <textarea name="message" placeholder="<?php esc_attr_e('Why Leave Us.', 'listingo'); ?>"></textarea>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pull-left">
