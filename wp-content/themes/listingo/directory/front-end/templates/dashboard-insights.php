	...
	<div class="tg-dashboard">
		...
		<div class="tg-alertmessages tg-ceomessage">
			...
			<div class="alert alert-danger tg-alertmessage fade in">
				<?php if( !empty( $com_title )) {?><h2><?php echo do_shortcode($com_title);?></h2><?php }?>
				<?php if( !empty( $com_description )) {?><span><?php echo do_shortcode($com_description);?></span><?php }?>
					...
					<div class="tg-ceocontent">
						...
						<?php if( !empty( $com_person_desg )) {?>
							<div class="tg-ceoinfo">
								...
								<span><?php echo esc_html($com_person_desg);?></span>
							</div>
						<?php }?>
					</div>
