                ...
                <div class="tg-dashboardbox tg-manageteam tg-ourteam">
                    ...
                    <div class="tg-manageteambox">
                        <div class="form-group search-input-wrap">
                            <input type="search" name="searchmember" class="form-control get_users_list" placeholder="<?php esc_attr_e('Search member via email id or username', 'listingo'); ?>">
                        </div>
                                        ...
                                        <li data-id="<?php echo esc_attr($user->ID); ?>" id="team-<?php echo esc_attr($user->ID); ?>">
                                            <div class="tg-teammember">
                                                ...
                                                <div class="tg-memberinfo">
                                                    <h5><a href="<?php echo esc_url($user_link); ?>"><?php echo esc_html($username); ?></a></h5>
                ...
                <form class="tg-themeform user-invitation-form">
                    <fieldset>
                        <div class="form-group">
                            <input type="email" name="email" class="form-control" placeholder="<?php esc_attr_e('Add email address', 'listingo'); ?>">
                        </div>
                        <textarea name="message" placeholder="<?php esc_attr_e('Invitation message', 'listingo'); ?>"></textarea>
                    </fieldset>
                </form>
            </div>
