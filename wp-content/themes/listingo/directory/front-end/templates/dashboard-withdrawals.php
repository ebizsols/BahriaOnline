        		...
        		<ul class="payment-withdrawal-options">
				  <li class="payment-withdrawal">
					<div class="withdrawal-wrap">
					  <input class="service-paypal" <?php checked( $db_withdrawal['type'], 'paypal', true ); ?>  id="withdrawal_paypal" data-service="<?php esc_attr_e('PayPal', 'listingo'); ?>" data-minimum="50.0" type="radio" value="paypal" name="withdrawal_account[type]">
					...
					<div class="tg-basicinformationbox withdrawal_paypal">
						<div class="row">
							...
							<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 pull-left">
								<div class="form-group">
									<input type="text" class="form-control" name="withdrawal_account[paypal]" value="<?php echo esc_attr( $db_withdrawal['paypal'] );?>" placeholder="<?php esc_attr_e('PayPal Account Email', 'listingo'); ?>">
								</div>
							</div>
						</div>
					</div>
