                    ...
                    <form class="tg-themeform tg-formamanagejobs sp-dashboard-profile-form">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left">
                                    <div class="form-group">
                                        <input type="text" name="job[title]" class="form-control" placeholder="<?php esc_attr_e('Job Title', 'listingo'); ?>">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left">
                                    <div class="form-group tg-iconinput">
                                        <i class="lnr lnr-calendar-full"></i>
                                        <input type="text" name="job[expirydate]" class="form-control expirydate" placeholder="<?php esc_attr_e('Expire Date', 'listingo'); ?>">
                                    </div>
                                </div>
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left tg-columnpadding">
                                    <div class="form-group tg-inputborder">
                                        <input type="text" name="job[salary]" class="form-control" placeholder="<?php esc_attr_e('Add salary/cost', 'listingo'); ?>">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left tg-columnpadding">
                                    <div class="form-group tg-inputborder">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left tg-columnpadding">
                                    <div class="form-group tg-inputborder">
                                        <input type="text" name="job[qualification]" class="form-control" placeholder="<?php esc_attr_e('What minimum qualification is required?', 'listingo'); ?>">
                                    </div>
                                </div>
                            ...
                            <div class="tg-dashboardbox tg-location">
                                ...
                                <div class="tg-locationbox">
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left">
                                            <div class="form-group">
                                                <input type="text" value="<?php echo esc_attr( $current_user->phone );?>" name="location[phone]" class="form-control" placeholder="<?php esc_attr_e('Phone', 'listingo'); ?>">
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left">
                                            <div class="form-group">
                                                <input type="text" value="<?php echo esc_attr( $current_user->fax );?>" name="location[fax]" class="form-control" placeholder="<?php esc_attr_e('Fax', 'listingo'); ?>">
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left">
                                            <div class="form-group">
                                                <input type="email" value="<?php echo esc_attr( $current_user->user_email );?>" name="location[email]" class="form-control" placeholder="<?php esc_attr_e('Email', 'listingo'); ?>">
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left">
                                            <div class="form-group">
                                                <input type="text" value="<?php echo esc_attr( $current_user->user_url );?>" name="location[url]" class="form-control" placeholder="<?php esc_attr_e('URL', 'listingo'); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 pull-left">
                                            <div class="form-group">
                                                <input type="text" value="<?php echo esc_attr($profile_longitude); ?>" placeholder="<?php esc_attr_e('Longitude', 'listingo'); ?>" name="location[longitude]" class="form-control" id="location-longitude" />
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 pull-left">
                                            <div class="form-group">
                                                <input type="text" placeholder="<?php esc_attr_e('Latitude', 'listingo'); ?>" value="<?php echo esc_attr($profile_latitude); ?>" name="location[latitude]" class="form-control" id="location-latitude" />
                                            </div>
                                        </div>
