...
<script type="text/template" id="tmpl-load-rejection-form">
    ...
    <input required name="rejection_title" type="text" placeholder="<?php esc_attr_e('Rejection Title', 'listingo'); ?>">
    </div>
    <textarea required name="rejection_reason" placeholder="<?php esc_attr_e('Rejection Description', 'listingo'); ?>"></textarea>
    </fieldset>
