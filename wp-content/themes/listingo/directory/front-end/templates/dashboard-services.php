                            ...
                            <?php if (!empty($price) || !empty($type) || !empty($freeservice)) { ?>
                                <span class="sp-price-wrapper">
                                    ...
                                    if (!empty($freeservice) && $freeservice === 'on') {
                                        ...
                                        <span class="sp-price-type"><?php echo esc_html($type); ?></span>
                                    <?php } ?>
                                </span>
                            <?php } ?>
                            ...
                            <fieldset>
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pull-left">
                                    <div class="form-group">
                                        <input type="text" value="<?php echo esc_attr($service_title); ?>" name="services[<?php echo esc_attr($key); ?>][title]" class="form-control sp-service-title-input" placeholder="<?php esc_attr_e('Service Title', 'listingo'); ?>">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left">
                                    <div class="form-group">
                                        <input type="text" value="<?php echo esc_attr($price); ?>" name="services[<?php echo esc_attr($key); ?>][price]" class="form-control sp-service-price-input" placeholder="<?php esc_attr_e('Service Price (Add price without currency symbol.)', 'listingo'); ?>">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left">
                                    <div class="form-group">
                                        <span class="tg-select">
                                            <select class="sp-service-price-type" name="services[<?php echo esc_attr($key); ?>][type]">
                                                ...
                                                <option data-key="<?php esc_attr_e('Hour', 'listingo'); ?>" <?php echo!empty($service['type']) && $service['type'] === 'hour' ? 'selected' : ''; ?> value="hour"><?php esc_html_e('Hour', 'listingo'); ?></option>
                                                <option data-key="<?php esc_attr_e('Visit', 'listingo'); ?>" <?php echo!empty($service['type']) && $service['type'] === 'visit' ? 'selected' : ''; ?> value="visit"><?php esc_html_e('Visit', 'listingo'); ?></option>
                                            </select>
                                        </span>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pull-left">
                                    <div class="form-group">
                                        <textarea name="services[<?php echo esc_attr($key); ?>][description]" placeholder="<?php esc_attr_e('Description', 'listingo'); ?>"><?php echo esc_html($description); ?></textarea>
                                    </div>
                                </div>
...
<script type="text/template" id="tmpl-load-services">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pull-left">
    <div class="form-group">
    <input type="text" name="services[{{data}}][title]" class="form-control sp-service-title-input" placeholder="<?php esc_attr_e('Service Title', 'listingo'); ?>">
    </div>
    </div>
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left">
    <div class="form-group">
    <input type="text" name="services[{{data}}][price]" class="form-control sp-service-price-input" placeholder="<?php esc_attr_e('Service Price (Add price without currency symbol.)', 'listingo'); ?>">
    </div>
    </div>
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left">
    <div class="form-group">
    ...
    <option value=""><?php esc_html_e('Choose Price Type', 'listingo'); ?></option>
    <option data-key="<?php esc_attr_e('Hour', 'listingo'); ?>" value="hour"><?php esc_html_e('Hour', 'listingo'); ?></option>
    <option data-key="<?php esc_attr_e('Visit', 'listingo'); ?>" value="visit"><?php esc_html_e('Visit', 'listingo'); ?></option>
    </select>
    </span>
    </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pull-left">
    <div class="form-group">
    <textarea name="services[{{data}}][description]" placeholder="<?php esc_attr_e('Description', 'listingo'); ?>"></textarea>
    </div>
    </div>
	<?php
		if (apply_filters('listingo_is_setting_enabled', $current_user->ID, 'subscription_appointments') === true 
