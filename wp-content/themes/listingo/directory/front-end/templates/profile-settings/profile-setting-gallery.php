													...
													<div class="tg-modalbody">
														<fieldset>
															<div class="form-group">
																<input type="text" value="<?php echo esc_attr( $meta_title );?>"  name="title" class="form-control meta-title" placeholder="<?php esc_attr_e('Add title', 'listingo'); ?>">
															</div>
															<div class="form-group">
																<input type="text" value="<?php echo esc_attr( $meta_link );?>" name="link" class="form-control meta-link" placeholder="<?php esc_attr_e('Add link', 'listingo'); ?>">
															</div>
														</fieldset>
													</div>
				...
				<div class="modal-dialog tg-modaldialog" role="document">
					<div class="modal-content tg-modalcontent">
						...
						<div class="tg-modalbody">
							<fieldset>
								<div class="form-group">
									<input type="text" value=""  name="title" class="form-control meta-title" placeholder="<?php esc_attr_e('Add title', 'listingo'); ?>">
								</div>
								<div class="form-group">
									<input type="text" value="" name="link" class="form-control meta-link" placeholder="<?php esc_attr_e('Add link', 'listingo'); ?>">
								</div>
							</fieldset>
						</div>
						<div class="tg-modalfoot">
