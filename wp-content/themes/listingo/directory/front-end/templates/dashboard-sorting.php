					...
					<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
						<div class="tg-designone activate-detail-page">
							<div class="tg-radio current-active">
								...
								<label for="designone">
									<img src="<?php echo esc_url( get_template_directory_uri());?>/images/design-one.jpg" alt="<?php esc_attr_e('Style 1', 'listingo'); ?>">
								</label>
							</div>
						</div>
					</div>
					<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
						<div class="tg-designtwo activate-detail-page">
							<div class="tg-radio current-active">
								...
								<label for="designtwo">
									<img src="<?php echo esc_url( get_template_directory_uri());?>/images/design-two.jpg" alt="<?php esc_attr_e('Style 2', 'listingo'); ?>">
								</label>
							</div>
						</div>
					</div>
						...
						<div class="tg-designone activate-detail-page">
							<div class="tg-radio current-active">
								...
								<label for="desigthree">
									<img src="<?php echo esc_url( get_template_directory_uri());?>/images/design-three.jpg" alt="<?php esc_attr_e('Style 3', 'listingo'); ?>">
								</label>
							</div>
						</div>
					</div>
					<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
						<div class="tg-designone activate-detail-page">
							<div class="tg-radio current-active">
								...
								<label for="desigthree">
									<img src="<?php echo esc_url( get_template_directory_uri());?>/images/design-four.jpg" alt="<?php esc_attr_e('Style 4', 'listingo'); ?>">
								</label>
							</div>
						</div>
					</div>
		...
		if( isset( $default_style ) && $default_style === 'view_4' ){
   		...
   		<div class="tg-dragdropoption">
			...
			<figure class="tg-dragdropimg">
				<img src="<?php echo esc_url( get_template_directory_uri());?>/images/drag-drop-banner-img.jpg" alt="<?php esc_attr_e('Visit Profile', 'listingo'); ?>">
