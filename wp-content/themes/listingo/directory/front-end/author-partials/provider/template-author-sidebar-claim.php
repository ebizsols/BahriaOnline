				...
				<form class="tg-themeform claim_form tg-claimform">
					<fieldset>
						<div class="form-group">
							<input type="text" class="form-control" name="subject" placeholder="<?php esc_attr_e('Report Subject', 'listingo'); ?>">
						</div>
						<div class="form-group">
							<textarea name="report" class="form-control" placeholder="<?php esc_attr_e('Detail', 'listingo'); ?>"></textarea>
						</div>
