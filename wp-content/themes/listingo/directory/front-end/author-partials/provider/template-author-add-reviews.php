				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pull-left">
					...
					<div class="form-group">
						<div class="tg-reviewtitle">
							<input type="text" name="reviewtitle" class="form-control" placeholder="<?php esc_attr_e('Review Title', 'listingo'); ?>">
						</div>
					...
					<div class="form-group">
						<textarea name="review_desc" class="form-control" placeholder="<?php esc_attr_e('Description', 'listingo'); ?>"></textarea>
					</div>
