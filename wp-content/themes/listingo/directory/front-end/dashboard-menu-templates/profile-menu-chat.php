...
if ( function_exists('fw_get_db_settings_option') && fw_ext('private-messaging')) { ?>
	<li class="tg-privatemessages tg-hasdropdown <?php echo do_shortcode($reference === 'messages' ? 'tg-active' : ''); ?>">
		...
		<ul class="tg-emailmenu">
			...
			<li class="<?php echo do_shortcode($mode === 'inbox' ? 'tg-active' : ''); ?>">
			...
			<li class="<?php echo do_shortcode($mode === 'sent' ? 'tg-active' : ''); ?>">
			...
			<li class="<?php echo do_shortcode($mode === 'trash' ? 'tg-active' : ''); ?>">
