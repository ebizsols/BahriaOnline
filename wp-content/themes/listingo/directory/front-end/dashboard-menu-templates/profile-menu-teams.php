...
?>
	<li class="tg-privatemessages tg-hasdropdown <?php echo do_shortcode($reference === 'team' ? 'tg-active tg-openmenu' : ''); ?>">
...
<?php } else{
	if (apply_filters('listingo_is_setting_enabled', $user_identity, 'subscription_teams') === true 
		...
		?>
		<li class="<?php echo do_shortcode($reference === 'team' ? 'tg-active' : ''); ?>">
