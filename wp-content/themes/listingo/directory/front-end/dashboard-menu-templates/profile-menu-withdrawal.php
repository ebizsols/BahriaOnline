...
if( ( isset( $bk_settings['type'] ) && $bk_settings['type'] === 'woo' && $bk_settings['hide_wallet'] === 'no'  ) 
	...
	<li class="tg-privatemessages tg-hasdropdown <?php echo do_shortcode($reference === 'statement' ? 'tg-active tg-openmenu' : ''); ?>">
		...
		<ul class="tg-emailmenu">
			<li class="<?php echo do_shortcode($mode === 'earnings' ? 'tg-active' : ''); ?>">
			...
			<li class="<?php echo do_shortcode($mode === 'withdrawals' ? 'tg-active' : ''); ?>">
...
if (apply_filters('listingo_is_setting_enabled', $user_identity, 'subscription_appointments') === true 
	...
	<li class="<?php echo do_shortcode($reference === 'withdrawal' ? 'tg-active' : ''); ?>">
