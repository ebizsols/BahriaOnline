...
if (apply_filters('listingo_is_setting_enabled', $user_identity, 'subscription_appointments') === true 
	...
	?>
	<li class="tg-hasdropdown <?php echo do_shortcode($reference === 'appointment' ? 'tg-active tg-openmenu' : ''); ?>">
		...
		<ul class="tg-emailmenu">
			<li class="<?php echo do_shortcode($mode === 'appointments' ? 'tg-active' : ''); ?>">
			...
			<li class="<?php echo do_shortcode($mode === 'appointment_schedules' ? 'tg-active' : ''); ?>">
			...
			<li class="<?php echo do_shortcode($mode === 'appointment_settings' ? 'tg-active' : ''); ?>">
