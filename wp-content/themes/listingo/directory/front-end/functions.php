 ...
 * @return 
 */
if( !function_exists( 'listingoGetRegisterSidebars' ) ) {
	function listingoGetRegisterSidebars(){
		global $wp_registered_sidebars;
		$am_sidebarsArray		= array();
		$am_sidebarsArray[''] 	= esc_html__('No Sidebar','listingo');
...
if( !function_exists( 'listingo_sidebars_get_current_position' ) ) {
	function listingo_sidebars_get_current_position($post_id=0){
