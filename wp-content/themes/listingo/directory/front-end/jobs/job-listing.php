                                                    ...
                                                    <tr>
                                                        <td>
                                                            <figure class="tg-companylogo">
                                                                <img src="<?php echo esc_url($avatar); ?>" alt="<?php esc_attr_e('Job post author.', 'listingo'); ?>">
                                                            </figure>
                                                            <div class="tg-contentbox">
                                                                <?php if (!empty($job_type)) { ?>
                                                                    <a class="tg-tag tg-featuredtag" href="javascript:;"><?php echo esc_html($job_type); ?></a>
                                                                <?php } ?>
                                                                <div class="tg-title">
                                                                    <h3><a href="<?php echo esc_url(get_permalink()); ?>"><?php echo get_the_title(); ?></a></h3>
                                                                </div>
                                                                <?php if (!empty($author_name)) { ?>
                                                                    <span><?php esc_html_e('By: ', 'listingo'); ?><?php echo esc_html($author_name); ?></span>
                                                                <?php } ?>
                                                            </div>
                                                        </td>
                                                        <td>
