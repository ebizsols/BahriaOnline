									...
									<?php if (!empty($author_avatar)) { ?>
										<div class="tg-companylogo">
											<a href="<?php echo esc_url(get_author_posts_url($post->post_author)); ?>">
												<img src="<?php echo esc_url($author_avatar); ?>" alt="<?php esc_attr_e('Related jobs', 'listingo'); ?>">
											</a>
										</div>
									<?php } ?>
									<div class="tg-companycontent">
										<?php if (!empty($job_type)) { ?>
											<a class="tg-tag tg-tagjobtype" href="javascript:;"><?php echo esc_html($job_type); ?></a>
										<?php } ?>
										<div class="tg-title">
										...
										<?php if (!empty($job_author_name)) { ?>
											...
											<?php esc_html_e('By: ', 'listingo'); ?> 
												<a href="javascript:;"><?php echo esc_html($job_author_name); ?></a>
											</span>
										<?php } ?>
									</div>
                                </div>
