                        ...
                        <div class="row">
                            <?php if( apply_filters('listingo_dev_manage_fields','true','first_name') === 'true' ){?>
								<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 pull-left">
									<div class="form-group">
										<input type="text" class="form-control" name="basics[first_name]" value="<?php echo get_user_meta($user_identity, 'first_name', true); ?>" placeholder="<?php esc_attr_e('First Name', 'listingo'); ?>">
									</div>
								</div>
                            <?php }?>
                            <?php if( apply_filters('listingo_dev_manage_fields','true','last_name') === 'true' ){?>
								<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
									<div class="form-group">
										<input type="text" class="form-control" name="basics[last_name]" value="<?php echo get_user_meta($user_identity, 'last_name', true); ?>" placeholder="<?php esc_attr_e('Last Name', 'listingo'); ?>">
									</div>
								</div>
                            <?php }?>
                            ...
                            <?php if( apply_filters('listingo_dev_manage_fields','true','phone') === 'true' ){?>
								<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 pull-left">
									<div class="form-group">
										<input type="text" class="form-control" name="basics[phone]" value="<?php echo get_user_meta($user_identity, 'phone', true); ?>" placeholder="<?php esc_attr_e('Phone', 'listingo'); ?>">
									</div>
								</div>
                            <?php }?>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 pull-left">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="basics[fax]" value="<?php echo get_user_meta($user_identity, 'fax', true); ?>" placeholder="<?php esc_attr_e('Fax', 'listingo'); ?>">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 pull-left">
                                <div class="form-group locate-me-wrap">
                                    ...
                                    <a href="javascript:;" class="geolocate"><img src="<?php echo esc_url( get_template_directory_uri()); ?>/images/geoicon.svg" width="16" height="16" class="geo-locate-me" alt="<?php esc_attr_e('Locate me!', 'listingo'); ?>"></a>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 pull-left">
                                <div class="form-group">
...
<script type="text/template" id="tmpl-load-media-links">
    ...
    <input type="text" name="videos[]" class="form-control" placeholder="<?php esc_attr_e('Audio/Video Link', 'listingo'); ?>">
    </div>
    </div>
...
<script type="text/template" id="tmpl-load-awards">
    ...
    <div class="form-group">
    <input type="text" class="form-control sp-awards-title-input" name="awards[{{data}}][title]" placeholder="<?php esc_attr_e('Certificates / Awards Title', 'listingo'); ?>">
    </div>
    </div>
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left">
    <div class="form-group">
    <input type="text" class="form-control awards_date" name="awards[{{data}}][date]" placeholder="<?php esc_attr_e('Date', 'listingo'); ?>">
    </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pull-left">
    <textarea class="form-control" name="awards[{{data}}][description]" placeholder="<?php esc_attr_e('Description', 'listingo'); ?>"></textarea>
    </div>
    </div>
    </div>
    </div>
...
<script type="text/template" id="tmpl-load-experience">
    ...
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left">
    <div class="form-group">
    <input type="text" class="form-control sp-job-title-input" name="experience[{{data}}][title]" placeholder="<?php esc_attr_e('Job Title', 'listingo'); ?>">
    </div>
    </div>
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left">
    <div class="form-group">
    <input type="text" class="form-control sp-job-company-input" name="experience[{{data}}][company]" placeholder="<?php esc_attr_e('Company Name', 'listingo'); ?>">
    </div>
    </div>
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left">
    <div class="form-group">
    <input type="text" class="form-control start_date" name="experience[{{data}}][start_date]" placeholder="<?php esc_attr_e('Starting Date', 'listingo'); ?>">
    </div>
    </div>
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left">
    <div class="form-group">
    <input type="text" class="form-control end_date" name="experience[{{data}}][end_date]" placeholder="<?php esc_attr_e('Ending Date', 'listingo'); ?>">
    </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pull-left">
    <textarea class="form-control" name="experience[{{data}}][description]" placeholder="<?php esc_attr_e('Description', 'listingo'); ?>"></textarea>
    </div>
    </div>
    </div>
    </div>
...
<script type="text/template" id="tmpl-load-qualification">
    ...
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left">
    <div class="form-group">
    <input type="text" class="form-control sp-degree-title-input" name="qualification[{{data}}][title]" placeholder="<?php esc_attr_e('Degree Name', 'listingo'); ?>">
    </div>
    </div>
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left">
    <div class="form-group">
    <input type="text" class="form-control sp-job-institute-input" name="qualification[{{data}}][institute]" placeholder="<?php esc_attr_e('Institute Name', 'listingo'); ?>">
    </div>
    </div>
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left">
    <div class="form-group">
    <input type="text" class="form-control start_date" name="qualification[{{data}}][start_date]" placeholder="<?php esc_attr_e('Starting Date', 'listingo'); ?>">
    </div>
    </div>
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left">
    <div class="form-group">
    <input type="text" class="form-control end_date" name="qualification[{{data}}][end_date]" placeholder="<?php esc_attr_e('Ending Date', 'listingo'); ?>">
    </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pull-left">
    <textarea class="form-control" name="qualification[{{data}}][description]" placeholder="<?php esc_attr_e('Description', 'listingo'); ?>"></textarea>
    </div>
    </div>
    </div>
    </div>
