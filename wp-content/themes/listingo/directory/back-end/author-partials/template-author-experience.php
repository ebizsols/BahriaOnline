							...
							<div class="tg-experience tg-certificatesaward" data-count-experinces="<?php echo intval($count_exp); ?>">
								<?php if (!empty($value['title'])) { ?>
									<div class="tg-imgandtitle">
										<h3><a class="sp-job-title" href="javascript:;"><?php echo esc_html($value['title']); ?></a></h3>
									</div>
								<?php } ?>
									...
									<div class="tg-themeform tg-formexperience">
									   <div class="sp-xs-12 sp-sm-12 sp-md-12 sp-lg-12">
										...
										<div class="sp-xs-12 sp-sm-6 sp-md-6 sp-lg-6">
											<div class="form-group">
												<input type="text" class="form-control sp-job-title-input" name="experience[<?php echo intval($count_exp); ?>][title]" placeholder="<?php esc_attr_e('Job Title', 'listingo'); ?>" value="<?php echo esc_attr($title); ?>">
											</div>
										</div>
										<div class="sp-xs-12 sp-sm-6 sp-md-6 sp-lg-6">
											<div class="form-group">
												<input type="text" class="form-control sp-job-company-input" name="experience[<?php echo intval($count_exp); ?>][company]" placeholder="<?php esc_attr_e('Company Name', 'listingo'); ?>" value="<?php echo esc_attr($company); ?>">
											</div>
										</div>
										<div class="sp-xs-12 sp-sm-6 sp-md-6 sp-lg-6">
											<div class="form-group">
												<input readonly type="text" class="form-control start_date" name="experience[<?php echo intval($count_exp); ?>][start_date]" placeholder="<?php esc_attr_e('Starting Date', 'listingo'); ?>" value="<?php echo esc_attr($start_date); ?>">
											</div>
										</div>
										<div class="sp-xs-12 sp-sm-6 sp-md-6 sp-lg-6">
											<div class="form-group">
												<input readonly type="text" class="form-control end_date" name="experience[<?php echo intval($count_exp); ?>][end_date]" placeholder="<?php esc_attr_e('Ending Date', 'listingo'); ?>" value="<?php echo esc_attr($end_date); ?>">
											</div>
										</div>
										<div class="sp-xs-12 sp-sm-12 sp-md-12 sp-lg-12">
											<textarea class="form-control" name="experience[<?php echo intval($count_exp); ?>][description]" placeholder="<?php esc_attr_e('Description', 'listingo'); ?>"><?php echo esc_textarea($description); ?></textarea>
										</div>
									</div>
								</div>
							</div>
