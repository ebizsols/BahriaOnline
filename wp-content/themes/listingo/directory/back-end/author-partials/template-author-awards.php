						...
						foreach ($profile_awards as $key => $value) {
							...
							<div class="tg-certificatesaward awards-parent-wrap-<?php echo esc_attr($counter_awards); ?>" data-count-awards="<?php echo intval($counter_awards); ?>">
								<div class="tg-imgandtitle">
									...
									<h3>
										<a class="sp-awards-title" href="javascript:;"><?php echo esc_html($value['title']); ?></a>
									</h3>
								</div>
								...
								<div class="sp-awards-edit-collapse tg-haslayout elm-display-none">
									<div class="tg-themeform tg-formcertificatesawards">
										...
										<div class="sp-xs-12 sp-sm-6 sp-md-6 sp-lg-6">
											<div class="form-group">
												<input type="text" class="form-control sp-awards-title-input" name="awards[<?php echo intval($counter_awards); ?>][title]" placeholder="<?php esc_attr_e('Certificates / Awards Title', 'listingo'); ?>" value="<?php echo esc_attr($award_title); ?>">
											</div>
										</div>
										<div class="sp-xs-12 sp-sm-6 sp-md-6 sp-lg-6">
											<div class="form-group">
												<input readonly type="text" class="form-control awards_date" name="awards[<?php echo intval($counter_awards); ?>][date]" placeholder="<?php esc_attr_e('Date', 'listingo'); ?>" value="<?php echo esc_attr($award_date); ?>">
											</div>
										</div>
										<div class="sp-xs-12 sp-sm-12 sp-md-12 sp-lg-12">
											<textarea class="form-control" name="awards[<?php echo intval($counter_awards); ?>][description]" placeholder="<?php esc_attr_e('Description', 'listingo'); ?>"><?php echo esc_textarea($award_description); ?></textarea>
										</div>
									</div>
								</div>
							</div>
