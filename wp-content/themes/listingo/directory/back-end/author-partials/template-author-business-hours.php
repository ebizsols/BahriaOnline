						...
						<fieldset>
							<div class="tg-dashboardbox tg-businesshours">
								<div class="tg-dashboardtitle">
									<h2><?php esc_html_e('Business Hourssssss', 'listingo'); ?></h2>
								</div>
								<?php
														...
														<div class="tg-startendtime">
															<div class="sp-row">
																<div class="form-group">
																	...
																	<input type="text" value="<?php echo esc_attr($start_time); ?>" name="schedules[<?php echo esc_attr($key); ?>][starttime][]" class="form-control business-hours-time" placeholder="<?php esc_attr_e('Start Time', 'listingo'); ?>">
																</div>
																<div class="form-group">
																	<i class="lnr lnr-clock"></i>
																	<input type="text" value="<?php echo esc_attr($end_time); ?>" name="schedules[<?php echo esc_attr($key); ?>][endtime][]" class="form-control business-hours-time" placeholder="<?php esc_attr_e('End Time', 'listingo'); ?>">
																</div>
																<?php if ($day_key > 0) { ?>
																	<button type="button" class="tg-addtimeslot tg-deleteslot delete-time-slot"><i class="lnr lnr-trash"></i></button>
																<?php } else { ?>
																	<button type="button" data-business_day="<?php echo esc_attr($key); ?>" class="tg-addtimeslot add-new-timeslot"><?php echo esc_html('+'); ?></button>
																<?php } ?>
															</div>
														</div>
														<?php
			...
			<div class="sp-row">
				<div class="form-group">
					<div class="tg-inpuicon">
						<i class="lnr lnr-clock"></i>
						<input type="text" name="schedules[{{data}}][starttime][]" class="form-control business-hours-time" placeholder="<?php esc_attr_e('Start Time', 'listingo'); ?>">
					</div>
				</div>
				<div class="form-group">
					<div class="tg-inpuicon">
						<i class="lnr lnr-clock"></i>
						<input type="text" name="schedules[{{data}}][endtime][]" class="form-control business-hours-time" placeholder="<?php esc_attr_e('End Time', 'listingo'); ?>">
					</div>
				</div>
				<button type="button" class="tg-addtimeslot tg-deleteslot delete-time-slot"><i class="lnr lnr-trash"></i></button>
			</div>
