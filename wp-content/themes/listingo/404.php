...
if (!function_exists('fw_get_db_settings_option')) {
    $logo_404['url'] = esc_url( get_template_directory_uri()).'/images/404.jpg';
            ...
            <div class="row">
                ...
                <div class="<?php echo esc_attr($class_404); ?>">
                    <div class="tg-404errorcontent">
                        ...
                        <?php } ?>
                        <?php get_search_form();?>
                        <span class="tg-gobackhome"><?php esc_html_e('Go Back To', 'listingo'); ?>&nbsp;<a href="<?php echo esc_url(home_url('/')); ?>"><?php esc_html_e('Home Page', 'listingo'); ?></a></span>
                    </div>
                </div>
            </div>
        </div>
