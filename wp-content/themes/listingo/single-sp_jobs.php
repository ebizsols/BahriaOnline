                            ...
                            <div class="tg-detailpageheadcontent">
                                <?php if (!empty($post_author)) { ?>
                                    <div class="tg-companylogo">
                                        <img src="<?php echo esc_url($avatar); ?>" alt="<?php esc_attr_e('Job author avatar', 'listingo'); ?>">
                                    </div>
                                <?php } ?>
                                <div class="tg-companycontent">
                                    <?php if (!empty($job_type)) { ?>
                                        <ul class="tg-tags">
                                            <li><a class="tg-tag" href="javascript:;"><?php echo esc_html($job_type); ?></a></li>
                                        </ul>
                                    <?php } ?>
                                    <div class="tg-title">
                                        <h1><?php echo get_the_title(); ?></h1>
                                        <span class="tg-jobpostedby"><?php esc_html_e('By: ', 'listingo'); ?>
                                            <a href="javascript:;"><?php echo esc_html($author_name); ?></a>
                                        </span>
                                    </div>
                                </div>
                                    ...
                                    <li>
                                        <div class="tg-box tg-views">
                                            ...
                                            <div class="tg-jobmatacontent">
                                                ...
                                                <span><?php echo esc_html($job_total_views); ?></span>
                                            </div>
                                        </div>
                                    </li>
                                <?php } ?>
                                        ...
                                        <ul>
                                            <?php if (!empty($career_level)) { ?>
                                                <li>
                                                    ...
                                                    <span><?php echo esc_html($career_level); ?></span>
                                                </li>
                                            <?php } ?>
                                        ...
                                        <ul class="tg-contactinfo">
                                            <?php if (!empty($profile_address)) { ?>
                                                <li>
                                                    ...
                                                    <address><?php echo esc_html($profile_address); ?></address>
                                                </li>
                                            <?php } ?>
                                            <?php if (!empty($phone)) { ?>
                                                <li>
                                            ...
                                            <?php if (!empty($email)) { ?>
                                                <li>
                                                    ...
                                                    <span><a href="mailto:<?php echo esc_attr($email); ?>?subject:<?php esc_html_e('Hello', 'listingo'); ?>"><?php echo esc_html($email); ?></a></span>
                                                </li>
                                            <?php } ?>
                                            <?php if (!empty($user_url)) { ?>
                                                <li>
                                                    <i class="lnr lnr-screen"></i>
                                                    <span><a href="<?php echo esc_url($user_url); ?>" target="_blank"><?php echo esc_html($user_url); ?></a></span>
                                                </li>
                                            <?php } ?>
                                        </ul>
                                        <?php
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left">
                            <div class="form-group">
                                <input type="text" value="<?php echo esc_attr( $user_name ); ?>" name="apply[name]" class="form-control" placeholder="<?php esc_attr_e('Name', 'listingo'); ?>">                                
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left">
                            <div class="form-group">
                                <input type="text" id="tg-date-birth" value="" calss="tg-date-birth form-control" name="apply[dob]" placeholder="<?php esc_attr_e('Date of Birth', 'listingo'); ?>">                                
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left">
                            <div class="form-group">
                                <input type="email" value="<?php echo esc_attr( $user_email ); ?>" name="apply[email]" class="form-control" placeholder="<?php esc_attr_e('Email', 'listingo'); ?>">                                
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left">
                            <div class="form-group">
                                <input type="text" value="<?php echo esc_attr( $user_cell ); ?>" name="apply[phone]" class="form-control" placeholder="<?php esc_attr_e('Phone', 'listingo'); ?>">                                
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left">
                            <div class="form-group">
                                <input type="text" value="" name="apply[education]" class="form-control" placeholder="<?php esc_attr_e('Education', 'listingo'); ?>">                                
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left">
                            <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left">
                            <div class="form-group">
                                <input type="text" value="<?php echo esc_attr( $user_address ); ?>" name="apply[address]" class="form-control" placeholder="<?php esc_attr_e('Address', 'listingo'); ?>">                                
                            </div>
                        </div>                       
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pull-left">
                            <div class="form-group">
                                <textarea name="apply[description]" placeholder="<?php esc_attr_e('Provide further details about yourself','listingo'); ?> "></textarea>
                            </div>
                        </div>                        
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-left">
                            <div class="form-group">
