 ...
 * @ Autor Themographics
 */
if (!class_exists('SC_VC_Core_SP_Blog_Posts_V2')) {

    class SC_VC_Core_SP_Blog_Posts_V2 extends SC_VC_Core {

        public function __construct() {
            add_action( "admin_init", array(
                &$this,
                "listingo_vc_blog_posts_v2_init"));
        }
         ...
         * # return {options
         */
        public function listingo_vc_blog_posts_v2_init() {
            vc_map(array(
                "name" => esc_html__("SP News Posts V2", 'listingo_vc_shortcodes'),
                "base" => "listingo_vc_blog_posts_v2",
                "class" => "",
                "controls" => "full",
                "show_settings_on_create" => true,
                "icon" => ListingoVCGlobalSettings::get_plugin_url() . '/vc_custom/shortcodes/sp-blog-posts-v2/images/screenshot.png',
    ...
    new SC_VC_Core_SP_Blog_Posts_V2();
}