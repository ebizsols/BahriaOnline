	...
	*/
	...
	function wc_bscure_superess_activate() {
	    ...
	    if ( ! $wc_bsecure::wc_bsecure_check_ssl() ) {
	       ...
	       @trigger_error(__('Please enable ssl to continue using this plugin.', 'ap'), E_USER_ERROR);     
	    }
	    ...
	    if ( $woocommerce_error ) {
	       ...
	       @trigger_error(__('Please update woocommerce plugin to continue using this plugin.', 'ap'), E_USER_ERROR);     
	    }
