...
class WC_Bsecure {	
	...
	public function bsecure_frontend_scripts() {        
        ...
        $bsecure_checkout_btn_url = !empty($bsecure_checkout_btn_url) ? $bsecure_checkout_btn_url. $queryString. 'v='.mt_rand() :
	     ...
	     wp_localize_script( 'bsecure_frontend_scripts', 'bsecure_js_object',
	            ...
	            array( 'ajax_url' => admin_url( 'admin-ajax.php' ), 'ajax_loader' => plugin_dir_url( __FILE__ ) . '../assets/images/ajax-loader.gif','nonce' => wp_create_nonce('bsecure-ajax-nonce'), 'wc_bsecure_is_active' => $wc_bsecure_is_active, 'wc_show_checkout_btn' => $wc_show_checkout_btn, 'wc_bsecure_title' => $wc_bsecure_title, 'wc_bsecure_checkout_btn_url' =>  $bsecure_checkout_btn_url,'bsecureWindow' => '','wc_auto_append_country_code' => $wc_auto_append_country_code, 'wc_is_hosted_checkout' => $wc_is_hosted_checkout, 'wc_cart_url' => wc_get_cart_url(), 'wc_checkout_url' => wc_get_checkout_url(), 'site_url' => site_url() ) );
    ...
    public function validateOrderData($order_data){
        ...
        if (empty($order_data->items) ){
            ...
            return  ['status' => true, 'msg' => __("No cart items returned from bSecure server. Please resubmit your order.", "wc-bsecure")];
    ...
    */
    public function getBsecureBtnHtml($page = 'cart', $onlyBtnUrl = false){       
        ...
        $btnUrl = !empty($bsecure_checkout_btn_url) ? $bsecure_checkout_btn_url. $queryString . 'v='.mt_rand() :
