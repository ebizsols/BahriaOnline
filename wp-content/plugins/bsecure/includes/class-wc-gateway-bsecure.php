...
class WC_Gateway_Bsecure extends WC_Payment_Gateway { 
    ...
    public function __construct() {
        ...
        $this->init_settings();
        $lock_image = plugins_url('bsecure') . "/assets/images/bsecure-lock-img.png";
        $this->default_desc = "<p>You will be redirected to a secure <img src='".$lock_image."'  > website to confirm your order</p>";
        $this->default_title = "Secure Payment";

        // Get settings.
        $this->title              = !empty($this->get_option( 'title' )) ? '<span class="bsecure-payment-gateway-title"><span>'.$this->get_option( 'title' ).'</span><span class="textWithImg"> <img src="'.$lock_image.'" class="bsecure-lock-img" > '.__($this->default_title,'wc-bsecure').'</span></span>' : '<span class="bsecure-payment-gateway-title"><span>'.__($this->default_title,'wc-bsecure').'</span> <img src="'.$lock_image.'" class="bsecure-lock-img" ></span>';
    ...
    public function get_title(){
        ...
        return !empty($paymentTitle) ? $paymentTitle : $this->title;
    }
    ...
    public function init_form_fields() {
        ...
        $this->form_fields = array(
            ...
            'title' => array(
                ...
                'default'     => __( 'Payment via bSecure', 'wc-bsecure' ),
                'desc_tip'    => true,
