    ...
    class Listingo_Category {
        ...
        public function init_sidebars_taxonomy() {
			$sidebars_labels = array(
				'name' 				=> esc_html__('Sidebars', 'listingo_core'),
				'singular_name' 	=> esc_html__('Sidebar','listingo_core'),
				'search_items' 		=> esc_html__('Search sidebar', 'listingo_core'),
				'all_items' 		=> esc_html__('All sidebars', 'listingo_core'),
				'parent_item' 		=> esc_html__('Parent sidebar', 'listingo_core'),
				'parent_item_colon' => esc_html__('Parent sidebar:', 'listingo_core'),
				'edit_item' 		=> esc_html__('Edit sidebar', 'listingo_core'),
				'update_item' 		=> esc_html__('Update sidebar', 'listingo_core'),
				'add_new_item' 		=> esc_html__('Add new sidebar', 'listingo_core'),
				'new_item_name' 	=> esc_html__('New sidebar name', 'listingo_core'),
				'menu_name' 		=> esc_html__('Sidebars', 'listingo_core'),
			);
			...
			register_taxonomy('sp_sidebars', 'sp_categories', $sidebars_args);
			
			$sidebars = get_terms( array(
				'taxonomy' 		=> 'sp_sidebars',
				'hide_empty' 	=> false,
			) );
			...
			foreach ( $sidebars as $sidebar ) {
				register_sidebar(
					array(
						'id'            => 'sp-' . sanitize_title( $sidebar->name ),
						'name'          => $sidebar->name,
