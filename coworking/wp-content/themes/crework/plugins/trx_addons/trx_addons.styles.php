...
if (!function_exists('crework_trx_addons_get_css')) {
	add_filter('crework_filter_get_css', 'crework_trx_addons_get_css', 10, 4);
	function crework_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
.sc_layouts_row_type_normal a:hover .sc_layouts_item_details_line1 {
...
.sc_layouts_row_type_narrow .sc_layouts_menu_mobile_button a .sc_layouts_item_icon,
.scheme_self.sc_layouts_row_type_narrow .sc_layouts_menu_mobile_button a .sc_layouts_item_icon {
	color: {$colors['text_dark']};
}
.sc_layouts_row_type_narrow .sc_layouts_menu_mobile_button a:hover .sc_layouts_item_icon,
.scheme_self.sc_layouts_row_type_narrow .sc_layouts_menu_mobile_button a:hover .sc_layouts_item_icon {
	color: {$colors['text_light']};
}
.sc_layouts_row_type_narrow .sc_layouts_item .sc_layouts_menu a,
.scheme_self.sc_layouts_row_type_narrow .sc_layouts_item .sc_layouts_menu a {
	color: {$colors['text_dark']};
}
...
.sc_layouts_row_type_compact .sc_layouts_item .sc_layouts_menu a:not(.sc_button):not(.button),
.scheme_self.sc_layouts_row_type_compact .sc_layouts_item .sc_layouts_menu a:not(.sc_button):not(.button){
	color: {$colors['text_dark']};
}
.sc_layouts_row_type_compact .sc_layouts_item .sc_layouts_menu a:not(.sc_button):not(.button):hover,
.scheme_self.sc_layouts_row_type_compact .sc_layouts_item .sc_layouts_menu a:not(.sc_button):not(.button):hover{
	color: {$colors['text_dark']};
}
...
.sc_layouts_row_type_compact .sc_layouts_menu_mobile_button a .sc_layouts_item_icon,
.scheme_self.sc_layouts_row_type_compact .sc_layouts_menu_mobile_button a .sc_layouts_item_icon {
	color: {$colors['text_link2']};
}
...
.sc_layouts_row_type_normal .sc_layouts_menu_mobile_button:hover .sc_layouts_item_icon{
...
.search_style_fullscreen.search_opened .search_form {
	border-color: {$colors['text_dark_031']};
}
.search_style_fullscreen.search_opened .search_close{
	color: {$colors['text_dark_058']};
}
...
.trx_addons_accent_bg.link2 {
	background-color: {$colors['text_link2']};
	color: {$colors['inverse_text']};
}
.trx_addons_accent_bg.link3 {
...
.trx_addons_copyright a:hover{
	color: {$colors['text_link']};
}

.trx_addons_widget_title_border:after {
...
.slider_outer_controls_side .slider_controls_wrap > a {
	color: {$colors['inverse_text']};
	background-color: {$colors['text_link3_061']};
	border-color: {$colors['text_link3_061']};
}
...
.sc_item_title_style_style_2.sc_item_descr {
	color:{$colors['extra_link2_085']};
}

.sc_item_subtitle.sc_item_title_style_s4:before,
.sc_item_title.sc_item_title_style_s4:before {
	border-color:#cdd0e1;
}
...
.sc_blogger_item .post_meta .post_categories_in {
	color: {$colors['text']};
}


.sc_blogger_modern .sc_blogger_item .sc_blogger_item_excerpt:after {
	border-color: #f7f5f0;
}
...
.scheme_self.sc_services_list .sc_services_item_icon {
	color: {$colors['text_dark']};
	border-color: {$colors['text_dark']};
}
...
.scheme_self.sc_services_list .sc_services_item:hover .sc_services_item_icon {
	color: {$colors['text_link3']};
	border-color: {$colors['text_link3']};
}
.scheme_self.sc_services_list .sc_services_item_title a:hover {
	color: {$colors['text_link3']};
}
...
.sc_services_list .sc_services_item.with_background {
	background-color:{$colors['alter_bg_hover']};
}

/**/

.sc_services.sc_services_number_icon .sc_services_item_number span:after{
...
.sc_services.sc_services_number_icon .sc_services_item_number span{
	color:{$colors['text']};
}
.sc_services.sc_services_number_icon .sc_services_item_icon {
	color:{$colors['text_link2']};
}
.sc_services.sc_services_number_icon .sc_services_item_icon:hover {
	color:{$colors['text_hover2']};
}
...
.sc_layouts_item .socials_wrap .social_item:nth-child(4n+1) .social_icon,
.sc_layouts_item .socials_wrap .social_item:nth-child(4n+2) .social_icon,
.sc_layouts_item .socials_wrap .social_item:nth-child(4n+3) .social_icon,
.sc_layouts_item .socials_wrap .social_item:nth-child(4n+4) .social_icon {
	border-color: {$colors['text_dark_015']};
}

.socials_wrap .social_item:nth-child(4n+1) .social_icon {
	background-color: #344973;
}
.socials_wrap .social_item:nth-child(4n+2) .social_icon {
	background-color: #1e83ae;
}
.socials_wrap .social_item:nth-child(4n+3) .social_icon {
	background-color: #ad416a;
}
.socials_wrap .social_item:nth-child(4n+4) .social_icon {
	background-color: #2057ba;
}

.sc_team_default .sc_team_item_socials .social_item:nth-child(4n+1) .social_icon,
.team_member_page .team_member_socials .social_item:nth-child(4n+1) .social_icon,
.content .socials_wrap .social_item:nth-child(4n+1) .social_icon {
	background-color: #395a99;
}
.sc_team_default .sc_team_item_socials .social_item:nth-child(4n+2) .social_icon,
.team_member_page .team_member_socials .social_item:nth-child(4n+2) .social_icon,
.content .socials_wrap .social_item:nth-child(4n+2) .social_icon {
	background-color: #50abf1;
}
.sc_team_default .sc_team_item_socials .social_item:nth-child(4n+3) .social_icon,
.team_member_page .team_member_socials .social_item:nth-child(4n+3) .social_icon,
.content .socials_wrap .social_item:nth-child(4n+3) .social_icon {
	background-color: #e74d89;
}
.sc_team_default .sc_team_item_socials .social_item:nth-child(4n+4) .social_icon,
.team_member_page .team_member_socials .social_item:nth-child(4n+4) .social_icon,
.content .socials_wrap .social_item:nth-child(4n+4) .social_icon {
	background-color: #005cff;
}

header .sc_layouts_item .socials_wrap .social_item:nth-child(4n+1) .social_icon,
header .sc_layouts_item .socials_wrap .social_item:nth-child(4n+2) .social_icon,
header .sc_layouts_item .socials_wrap .social_item:nth-child(4n+3) .social_icon,
header .sc_layouts_item .socials_wrap .social_item:nth-child(4n+4) .social_icon {
	background-color: transparent;
}
...
.sc_testimonials .slider_outer_controls_bottom .slider_controls_wrap > a:hover {
...
.sc_team.sc_team_default .trx_addons_hover_mask {
