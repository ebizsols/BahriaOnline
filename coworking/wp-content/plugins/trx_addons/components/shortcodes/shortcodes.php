...
*/
			...
			'button' => array(
							...
							'layouts_sc' => array(
								'default' => esc_html__('Default', 'trx_addons'),
								'only_icon' => esc_html__('Only Icon with border', 'trx_addons'),
			...
			'title' => array(
							...
							'layouts_sc' => array(
								'default' => esc_html__('Default', 'trx_addons'),
								'style_2' => esc_html__('Style 2', 'trx_addons'),
								's3' => esc_html__('Style 3', 'trx_addons'),
								's4' => esc_html__('Style 4', 'trx_addons'),
								's5' => esc_html__('Style 5', 'trx_addons'),
								's6' => esc_html__('Style 6', 'trx_addons')
							),
							// Always enabled!!!
							'std' => 1
						)
	...
	function trx_addons_vc_add_slider_param($group=false) {
		$params = array(
					...
					array(
						...
						"value" => array(
							esc_html__('None', 'trx_addons') => 'none',
							esc_html__('Top', 'trx_addons') => 'bottom'
	...
	function trx_addons_vc_add_title_param($group=false, $button=true) {
		$params = array(
					array(
						...
						"description" => wp_kses_data( __("Select style", 'trx_addons') ),
						"admin_label" => true,
					...
					array(
						...
						"description" => wp_kses_data( __("Title of the block. Enclose any words in {{ and }} to drop them to the next line", 'trx_addons') ),
						"admin_label" => true,
						'edit_field_class' => 'vc_col-sm-6',
						"type" => "textfield"
					),
