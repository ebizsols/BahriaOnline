	...
	function trx_addons_sc_services_add_in_vc_params() {
		...
		$params = array_merge(
				array(
					...
					array(
						"param_name" => "show_bg",
						"heading" => esc_html__("Show background", 'trx_addons'),
						"description" => wp_kses_data( __("Check if you want show baclground color", 'trx_addons') ),
						'dependency' => array(
							'element' => 'type',
							'value' => 'list'
						),
						'edit_field_class' => 'vc_col-sm-4',
						"std" => "0",
						"value" => array(esc_html__("Show bg", 'trx_addons') => "1" ),
						"type" => "checkbox"
					),
					array(
