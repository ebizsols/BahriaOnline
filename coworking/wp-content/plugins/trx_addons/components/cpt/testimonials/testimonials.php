		...
		return apply_filters('trx_addons_sc_map', array(
				...
				"params" => array_merge(
					array(
						...
						array(
							"param_name" => "hide_quote_testimpnials",
							"heading" => esc_html__("Hide quote icon", 'trx_addons'),
							"description" => wp_kses_data( __("Check if you want hide quote icon", 'trx_addons') ),
							'edit_field_class' => 'vc_col-sm-6',
							'dependency' => array(
								'element' => 'type',
								'value' => 'default'
							...
							"std" => "0",
							"value" => array(esc_html__("Hide quote", 'trx_addons') => "1" ),
							"type" => "checkbox"
						),
						array(
							"param_name" => "cat",
