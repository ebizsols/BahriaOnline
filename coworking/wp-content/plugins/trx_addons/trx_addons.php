...
// Current version
if ( ! defined( 'TRX_ADDONS_VERSION' ) ) define( 'TRX_ADDONS_VERSION', '2.0.29.4' );
...
if ( !function_exists('trx_addons_init') ) {
	...
	function trx_addons_init() {
		...
		$thumb_sizes = apply_filters('trx_addons_filter_add_thumb_sizes', array(
			...
			'trx_addons-thumb-post-modern'	=> array(385, 304, true),
			'trx_addons-thumb-team'			=> array(370, 411, true),
			'trx_addons-thumb-blogger'		=> array(370, 259, true),
